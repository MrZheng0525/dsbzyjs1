...
class ReadConfig():
    ...
    def get_content(self, modular, name):
        value = config.get(modular, name)
        return value
...
if __name__ == '__main__':#测试一下，我们读取配置文件的方法是否可用
    print(ReadConfig().get_content('DATABASE','host'),
            ReadConfig().get_content('DATABASE','user'),
            ReadConfig().get_content('DATABASE','password'))
